			...
			<div class="page-header">
				<div class="row align-items-center">
					...
					<div class="col-auto float-end ms-auto">
						<a href="{{ route('posts.create') }}" class="btn add-btn"><i class="fa fa-plus"></i> Add Post</a>
					</div>
				</div>
			</div>
			<!-- /Page Header -->
						...
						<table class="table table-striped custom-table mb-0 datatable" id="dataTable">
							...
							<tbody>
								...
								<tr>
									...
									<td>{{ $post->likes }}</td>
									<td class="text-end">
                                        <a class="edit-overview" href="{{ route('posts.edit',$post->id) }}" title="Edit"><i class="fa fa-pencil m-r-5"></i> </a>
                                       	<a href="javascript:void(0);" data-id='{{ $post->id }}' class="delete" data-bs-toggle="modal" data-bs-target="#delete" title="Delete"><i class="fa fa-trash-o m-r-5"></i></a>
									</td>
								</tr>
								@endforeach
							</tbody>
